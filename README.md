...
Final year Informatics Engineering student at UIN Sunan Gunung Djati Bandung, currently working as a Data Specialist Intern at IPDN. I move between leading teams as a project manager and building things hands on, from machine learning models to full stack web and mobile apps.

Currently building a hybrid IndoBERT + LSTM model for stock price prediction as my undergraduate thesis, and previously worked as a Project Manager in SCRUM based software teams.
...
|---|---|---|
| [SIPK Praja](https://github.com/renit21c/-Web-SIPAK) | AI assisted case management and disciplinary investigation system for IPDN | React · Laravel · FastAPI · PostgreSQL |
| [Cikanyere Ville](https://github.com/renit21c/-Web-CikanyereVille) | Digital village portal for Desa Cikanyere with an admin dashboard | JavaScript · Node.js · Supabase |
...
Reach me through my [portfolio](https://whoisren.vercel.app/) or [LinkedIn](https://linkedin.com/in/sumarenata).
